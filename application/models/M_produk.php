...
class M_produk extends CI_Model{
	...
	function simpan_produk($judul,$harga,$isi,$kategori_id,$kategori_nama,$user_id,$user_nama,$gambar,$slug,$persetujuan){
		$hsl=$this->db->query("insert into tbl_produk(produk_judul,produk_harga,produk_isi,produk_kategori_id,produk_kategori_nama,produk_pengguna_id,produk_author,produk_gambar,produk_slug,persetujuan) values ('$judul','$harga','$isi','$kategori_id','$kategori_nama','$user_id','$user_nama','$gambar','$slug','$persetujuan')");
		return $hsl;
	}
	...
	function update_produk($produk_id,$judul,$harga,$isi,$kategori_id,$kategori_nama,$user_id,$user_nama,$gambar,$slug,$persetujuan){
		$hsl=$this->db->query("update tbl_produk set produk_judul='$judul',produk_harga='$harga',produk_isi='$isi',produk_kategori_id='$kategori_id',produk_kategori_nama='$kategori_nama',produk_pengguna_id='$user_id',produk_author='$user_nama',produk_gambar='$gambar',produk_slug='$slug',persetujuan='$persetujuan' where produk_id='$produk_id'");
		return $hsl;
	}
	function update_produk_tanpa_img($produk_id,$judul,$harga,$isi,$kategori_id,$kategori_nama,$user_id,$user_nama,$slug,$persetujuan){
		$hsl=$this->db->query("update tbl_produk set produk_judul='$judul',produk_isi='$isi',produk_harga='$harga',produk_kategori_id='$kategori_id',produk_kategori_nama='$kategori_nama',produk_pengguna_id='$user_id',produk_author='$user_nama',produk_slug='$slug',persetujuan='$persetujuan' where produk_id='$produk_id'");
		return $hsl;
	}

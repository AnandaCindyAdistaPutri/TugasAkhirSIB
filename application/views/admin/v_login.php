...
<head>
  ...
  <style type="text/css">
      body{
        background-image: url('<?php echo base_url('assets/images/store.png')?>');
                ...
                <section class="">
                  <form action="<?php echo site_url('/administrator/auth')?>" method="POST">
                    ...
                    <div>
                      ...
                      <a class="btn btn-success" href="<?= site_url()?>"><span><i class="fa fa-angle-left pull-left"> Back To Menu </i></span></a>
                    </div>
                  </form>
                </section><br>

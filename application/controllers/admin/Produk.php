	...
	function simpan_produk(){
	            ...
	            if(!empty($_FILES['filefoto']['name']))
	            {
	                if ($this->upload->do_upload('filefoto'))
	                {
							...
							$persetujuan=strip_tags($this->input->post('persetujuan'));
							...
							$this->m_produk->simpan_produk($judul,$harga,$isi,$kategori_id,$kategori_nama,$user_id,$user_nama,$gambar,$slug,$persetujuan);
	...
	function update_produk(){
	            ...
	            if(!empty($_FILES['filefoto']['name']))
	            {
	                if ($this->upload->do_upload('filefoto'))
	                {
							...
							$user_id=$p['pengguna_id'];
							$user_nama=$p['pengguna_nama'];
							$this->m_produk->update_produk($produk_id,$judul,$harga,$isi,$kategori_id,$kategori_nama,$user_id,$user_nama,$gambar,$slug,$persetujuan);
	                    ...
	                    redirect('admin/pengguna');
							...
							$user_id=$p['pengguna_id'];
							$user_nama=$p['pengguna_nama'];
							$this->m_produk->update_produk_tanpa_img($produk_id,$judul,$harga,$isi,$kategori_id,$kategori_nama,$user_id,$user_nama,$slug,$persetujuan);
							echo $this->session->set_flashdata('msg','info');
							redirect('admin/produk');
	            } 
